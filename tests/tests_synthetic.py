...
def test_03_constants_sanity_checks():
...
def test_04_failurepatterns_compiled_regex_list():
...
def test_05_detectfailurereason_filebased_detection():
...
def test_06_getstartingrow_resumption_logic():
...
def test_07_savesamples_output_format_and_append_behavior():
...
def test_08_savecaisample_cai_output_format():
...
def test_09_chunktext_splitting_long_texts():
...
def test_10_setuptritoncache_directory_creation():
...
def test_11_setuptritoncache_stale_file_cleanup():
...
def test_12_datasetloader_local_jsonl_file():
...
def test_13_datasetloader_local_directory_with_jsonl():
...
def test_14_datasetloader_shuffle_with_seed():
...
def test_15_datasetloader_unsupported_format_raises_error():
...
def test_16_getnvidiasmivram_graceful_fallback():
...
def test_17_generatepy_argument_parser_defaults_and_required_args():
...
def test_18_generatecaipy_argument_parser_defaults_and_required_args():
...
def test_19_constitutionalgeneration_no_critique_path():
...
def test_20_constitutionalgeneration_with_critique_and_revision():
...
def test_21_runrollouts_endtoend_with_mocks():
...
def test_22_runcairollouts_endtoend_with_mocks():
...
def test_23_runcairollouts_skips_oversized_prompts():
...
def test_24_datasetloader_parquet_file():
...
def test_25_savesamples_getstartingrow_roundtrip():
...
def test_26_datasetloader_metadatacolumns_and_textcolumn_extraction():
...
if __name__ == "__main__":
    ...
    test_03_constants_sanity_checks()
    test_04_failurepatterns_compiled_regex_list()
    test_05_detectfailurereason_filebased_detection()
    test_06_getstartingrow_resumption_logic()
    test_07_savesamples_output_format_and_append_behavior()
    test_08_savecaisample_cai_output_format()
    test_09_chunktext_splitting_long_texts()
    test_10_setuptritoncache_directory_creation()
    test_11_setuptritoncache_stale_file_cleanup()
    test_12_datasetloader_local_jsonl_file()
    test_13_datasetloader_local_directory_with_jsonl()
    test_14_datasetloader_shuffle_with_seed()
    test_15_datasetloader_unsupported_format_raises_error()
    test_16_getnvidiasmivram_graceful_fallback()
    test_17_generatepy_argument_parser_defaults_and_required_args()
    test_18_generatecaipy_argument_parser_defaults_and_required_args()
    test_19_constitutionalgeneration_no_critique_path()
    test_20_constitutionalgeneration_with_critique_and_revision()
    test_21_runrollouts_endtoend_with_mocks()
    test_22_runcairollouts_endtoend_with_mocks()
    test_23_runcairollouts_skips_oversized_prompts()
    test_24_datasetloader_parquet_file()
    test_25_savesamples_getstartingrow_roundtrip()
    test_26_datasetloader_metadatacolumns_and_textcolumn_extraction()
    print("\n" + "=" * 50)
