"""
Training Configuration Specifications for Fully Sharded Data Parallel (FSDP) Training of Large-Scale Transformer Models
...
class TrainingArguments:
    ...
    mfu_type: Optional[str] = field(
        ...
        metadata={"help": (
            ...
            "Options currently include: `dense_transformer`. "
