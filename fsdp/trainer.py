"""
Trainer class for the FSDP training loop.
            ...
            if (
                ...
                if already_validated:
                    ...
                    if master_process:
                        ...
                        # For FSDP, we pass the full (un-sharded) state dict gathered above.
                        if fsdp:
                        ...
                        torch.save(
                            ...
                            'epoch': epoch,
                            'config': model.config,
                            'optimizer': opt_state_dict if fsdp else optimizer.state_dict(),
                            }, 
