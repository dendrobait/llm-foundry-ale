...
# Main Job Execution
#############################################
python3 "$workdir/train_tokenizer_tokenizers.py" \
    --data_path "$workdir/portuguese/tokenizers/portuguese" \
    --data_type "parquet" \
    ...
    --vocab_size 49152 \
    --output_dir "$workdir/portuguese/checkpoints/tokenizers/hf-bpe" \
